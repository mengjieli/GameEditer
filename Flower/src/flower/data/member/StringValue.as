package flower.data.member
{
	public class StringValue extends Value
	{
		...
		public function StringValue(initValue:*="")
		{
			if(initValue) {
				_value = "" + initValue;
			}
		...
		private static var pool:Vector.<StringValue> = new Vector.<StringValue>();
		public static function create(initValue:*=null):StringValue {
		...
		public static function release(value:StringValue):void {
			value.dispose();
			pool.push(value);
		}
	}
