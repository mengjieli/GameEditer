package flower.data.member
{
	public class BooleanValue extends Value
	{
		...
		public function BooleanValue(initValue:*=false)
		{
			if(initValue) {
				_value = !!initValue;
			}
		...
		private static var pool:Vector.<BooleanValue> = new Vector.<BooleanValue>();
		public static function create(initValue:*=null):BooleanValue {
			...
			if(pool.length) {
				...
				value = new BooleanValue(initValue);
			}
			return value;
		}
		
		public static function release(value:BooleanValue):void {
			value.dispose();
			pool.push(value);
		}
	}
