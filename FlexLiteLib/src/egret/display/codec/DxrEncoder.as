package egret.display.codec
{
	...
	import egret.display.DxrData;
	import egret.display.image.Jpeg32Encoder;
	import egret.display.image.JpegXREncoder;
	import egret.display.image.PngEncoder;
	import egret.utils.CRC32Util;
	...
	public class DxrEncoder extends DxrDrawer
	{
		 ...
		 * 复写父级方法，修正非整数的偏移量。
		 */		
		override ns_egret function drawDisplayObject(dp:DisplayObject, dxrData:DxrData, frame:int):void
		{
