package egret.display.codec
{
	...
	public class DxrDrawer
	{
		 ...
		 */		
		ns_egret function drawDisplayObject(dp:DisplayObject,dxrData:DxrData,frame:int):void
		{
		 ...
		 * 绘制一个显示对象的当前外观，存储其一帧位图信息到dxrData内
		 */		
		ns_egret function drawWithoutFilter(dp:DisplayObject,dxrData:DxrData,frame:int):void
		{
			var dpRect:Rectangle = dp.getBounds(dp);
...
//			dxrData.frameOffsetList[frame] = new Point(dpRect.left,dpRect.top);
		 ...
		 */		
		ns_egret function getColorRect(bitmapData:BitmapData):Rectangle
		{
