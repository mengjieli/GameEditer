package egret.display
{
	...
	import egret.core.IInvalidateDisplay;
	...
	public class Scale9GridBitmap extends Shape implements IInvalidateDisplay
	{
		...
		ns_egret var _offsetPoint:Point;
		 ...
		 */
		ns_egret function get offsetPoint():Point
		{
			return _offsetPoint;
		}
		 ...
		 * @private
		 */
		ns_egret function set offsetPoint(value:Point):void
		{
		 ...
		 * 滤镜宽度,在子类中赋值
		 */		
		ns_egret var filterWidth:Number = 0;
		/**
		 * 滤镜高度,在子类中赋值
		 */		
		ns_egret var filterHeight:Number = 0;
		/**
		 * 缓存的源九宫格网格坐标数据
		 */		
