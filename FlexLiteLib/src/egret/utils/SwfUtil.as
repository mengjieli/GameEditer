...
//			return extractFromSwf(oldSwf,symbols);
		 ...
		 * 从swf对象里提取指定列表的导出类
		 */		
		private static function extractFromSwf(oldSwf:*,symbols:Array):ByteArray
		{
...
//			}
		 ...
		 */		
		private static function getTags(swf:*,tagId:uint,tags:Array):void
		{
//			var tag:ITag;
