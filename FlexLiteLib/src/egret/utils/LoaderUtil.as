package egret.utils
{
	...
	import egret.utils.loader.MultiLoader;
	import egret.utils.loader.MultiURLLoader;
	import egret.utils.loader.RootLoader;
	import egret.utils.loader.SingleLoader;
	import egret.utils.loader.SingleURLLoader;
	...
	public class LoaderUtil
	{
		...
		public static function loadXML(url:String,onComp:Function,onProgress:Function=null,onIoError:Function=null):void
		{
			...
			xmlLoader.loaEXML(url,onComp,onProgress,onIoError);
		}
		/**
		 ...
		 * @param onIoError
		 */		
		public static function loadSwc(url:String,onComp:Function,onProgress:Function=null,onIoError:Function=null):void
		{
