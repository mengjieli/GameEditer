package egret.components.supportClasses
{
	...
	public class SkinnableTextBase extends SkinnableComponent
	{
		...
		ns_egret function getWidthInChars():Number
		{
		...
		ns_egret function setWidthInChars(value:Number):void
		{
			if (textDisplay)
			{
				var richEditableText:EditableText = textDisplay as EditableText;
		...
		ns_egret function getHeightInLines():Number
		{
			var richEditableText:EditableText = textDisplay as EditableText;
		...
		ns_egret function setHeightInLines(value:Number):void
		{
			if (textDisplay)
			{
				var richEditableText:EditableText = textDisplay as EditableText;
		...
		{
			var focus:InteractiveObject = stage?stage.focus:null;
			var skin:Object = _skin;
