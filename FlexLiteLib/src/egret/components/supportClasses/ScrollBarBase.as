package egret.components.supportClasses
{
	...
	public class ScrollBarBase extends TrackBase
	{
		...
		ns_egret static var cachePoint:Point = new Point();
		 ...
		 */
		ns_egret var useMouseWheelDelta:Boolean
		...
		public function set viewport(value:IViewport):void
		{
			...
			if (_viewport)  
			{
				...
				_viewport.removeEventListener(ResizeEvent.UI_RESIZE, viewportResizeHandler);
			...
			if (_viewport)  
			{
				...
				_viewport.addEventListener(ResizeEvent.UI_RESIZE, viewportResizeHandler);
		 ...
		 * 开始播放动画
		 */		
		ns_egret function startAnimation(duration:Number, valueTo:Number, 
		 ...
		 * 目标视域组件尺寸发生改变
		 */		
		ns_egret function viewportResizeHandler(event:ResizeEvent):void
		{
		}
		 ...
		 * 目标视域组件的内容宽度发生改变。
		 */		
		ns_egret function viewportContentWidthChangeHandler(event:PropertyChangeEvent):void
		{
		}
		 ...
		 * 目标视域组件的内容高度发生改变。
		 */		
		ns_egret function viewportContentHeightChangeHandler(event:PropertyChangeEvent):void
		{
		}
		 ...
		 */		
		ns_egret function viewportHorizontalScrollPositionChangeHandler(event:PropertyChangeEvent):void
		{
		}  
		 ...
		 */		
		ns_egret function viewportVerticalScrollPositionChangeHandler(event:PropertyChangeEvent):void
		{
		} 
		 ...
		 * 立即停止动画的播放
		 */		
		ns_egret function stopAnimation():void
		{
