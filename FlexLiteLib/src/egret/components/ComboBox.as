package egret.components
{
	...
	import egret.components.supportClasses.DropDownListBase;
	 ...
	 * @see egret.components.DropDownList
	 * @author dom
	 */	
	public class ComboBox extends DropDownListBase
	{
		 ...
		 * @inheritDoc
		 */
		override ns_egret function set userProposedSelectedIndex(value:Number):void
		{
		...
		ns_egret function applySelection():void
		{
		 ...
		 * @inheritDoc
		 */
		override ns_egret function changeHighlightedSelection(newIndex:int, scrollToTop:Boolean = false):void
		{
		 ...
		 * @inheritDoc
		 */
		override ns_egret function dropDownController_openHandler(event:UIEvent):void
		{
