package egret.components
{
	...
	public class RadioButtonGroup extends EventDispatcher
	{
		 ...
		 * 添加单选按钮到组内
		 */
		ns_egret function addInstance(instance:RadioButton):void
		{
		 ...
		 * 从组里移除单选按钮
		 */		
		ns_egret function removeInstance(instance:RadioButton):void
		{
		 ...
		 * 设置选中的单选按钮
		 */		
		ns_egret function setSelection(value:RadioButton, fireChange:Boolean = true):void
		{
			if (_selection == value)
				return;
