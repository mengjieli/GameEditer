package egret.managers
{
	...
	import egret.managers.layoutClass.DepthQueue;
	...
	public class LayoutManager extends EventDispatcher
	{
		...
		{
			UIGlobals.stage.addEventListener(Event.ENTER_FRAME,doPhasedInstantiationCallBack);
			UIGlobals.stage.addEventListener(Event.RENDER, doPhasedInstantiationCallBack);
		...
		{
			UIGlobals.stage.removeEventListener(Event.ENTER_FRAME,doPhasedInstantiationCallBack);
			UIGlobals.stage.removeEventListener(Event.RENDER, doPhasedInstantiationCallBack);
