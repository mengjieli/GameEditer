package egret.managers.dragClasses
{
	...
	import egret.effects.Move;
	import egret.effects.Scale;
	...
	{
		public var onUnderPointDisable:Function;
		public var onUnderPointEnable:Function;
								  ...
								  dragSource:DragSource)
		{
			...
			stageRoot = dragInitiator.stage;
			if(!stageRoot)
			{
				stageRoot = UIGlobals.stages[0];
			}
		...
		private function mouseMoveHandler(event:MouseEvent):void
		{
			...
			if (target)
			{
				...
				if (!foundIt)
				{
					...
					if(onUnderPointDisable != null)
					{
						onUnderPointDisable();
					}
				}else
				{
					if(onUnderPointEnable != null)
					{
						onUnderPointEnable();
					}
				}
