package egret.managers
{
	...
	import egret.events.PopUpEvent;
	import egret.managers.impl.PopUpManagerImpl;
	...
	public class PopUpManager
	{
		 ...
		 * 模态遮罩的填充颜色
		 */
		public static function get modalColor():uint
		{
			return impl.modalColor;
		}
		public static function set modalColor(value:uint):void
		{
		 ...
		 * 模态遮罩的透明度
		 */
		public static function get modalAlpha():Number
		{
			return impl.modalAlpha;
		}
		public static function set modalAlpha(value:Number):void
		{
