package egret.managers
{
	...
	public class SystemContainer implements IContainer
	{
		...
		private var raw_getElementAt:QName = new QName(ns_egret, "raw_getElementAt");
		private var raw_addElementAt:QName = new QName(ns_egret, "raw_addElementAt");
		private var raw_getElementIndex:QName = new QName(ns_egret, "raw_getElementIndex");
		private var raw_removeElement:QName = new QName(ns_egret, "raw_removeElement");
		private var raw_removeElementAt:QName = new QName(ns_egret, "raw_removeElementAt");
		private var raw_setElementIndex:QName = new QName(ns_egret, "raw_setElementIndex");
		/**
		 * @inheritDoc
		 */
